...
<p align="center">
<img src="./img/2.3ProblemSetup.svg">
</p>
...
Step 2.
 You **cannot** use the given angles directly. The angle between the two vectors orginally is $(90-10)-15 = 65\degree{}$
 
 When drawing the triangle head-to-tail, the interior angle becomes $$180\degree -65\degree = 115\degree$$
 The 180 comes from the sum on interior angles of a triangle.

 <p align="center">
 <img src="./img/2.3TriangleLawOfCosines.svg">
 </p>
...
Dont let the name fool you, this is industry standard and works with the same exact process every time regardless of the number of vectors involved. 

Step 1: Resolve Forces into X and Y components

$F_{1x} = 100\cos{15\degree}$
$F_{1y} = 100\sin{15\degree}$
$F_1 = [96.59,25.88]\ \text{N}$
...
<p align="center">
<img src="./img/2.3TriangleCompositeVector.svg">
</p>
Now resolve Force 2

$F_{2x} = 150\cos{80\degree}$
$F_{2y} = 150\sin{80\degree}$
$F_2 = [26.05,147.72]\ \text{N}$
