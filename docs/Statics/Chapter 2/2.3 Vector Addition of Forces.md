...
![Setup](img/2.3ProblemSetup.svg){: style="width:100%; max-width:800px; display:block; margin: 0 auto" }
...
Step 2.
 ...
 ![Cosines](img/2.3TriangleLawOfCosines.svg){: style="width:100%; max-width:600px; display:block; margin: 0 auto"}
...
![Composite](img/2.3TriangleCompositeVector.svg){: style="width:100%; max-width:600px; display:block; margin: 0 auto"}
